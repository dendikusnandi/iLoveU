...
cd 
wget -O /usr/local/bin/ohp "https://raw.githubusercontent.com/dendikusnandi/iLoveU/main/FILE/OPENVPN/ohp"
...
[Unit]
Description=Direct Squid Proxy For OpenVPN TCP By Dendi Kusnandi
