...
###########- COLOR CODE -##############
colornow=$(cat /etc/dendikusnandi/theme/color.conf)
export NC="\e[0m"
export YELLOW='\033[0;33m';
export RED="\033[0;31m" 
export COLOR1="$(cat /etc/dendikusnandi/theme/$colornow | grep -w "TEXT" | cut -d: -f2|sed 's/ //g')"
export COLBG1="$(cat /etc/dendikusnandi/theme/$colornow | grep -w "BG" | cut -d: -f2|sed 's/ //g')" 
WH='\033[1;37m'                   
###########- Dendi Kusnandi-##########
...
echo "IP=$host" > /var/lib/dendikusnandi-pro/ipvps.conf
echo ""
...
sleep 2
wget -q -O /root/install_up.sh "https://raw.githubusercontent.com/dendikusnandi/iLoveU/main/FILE/PLUGINS/install-up.sh" && chmod +x /root/install_up.sh
sleep 2
./install_up.sh
sleep 5
rm /root/install_up.sh
rm /opt/.ver
version_up=$( curl -sS https://raw.githubusercontent.com/dendikusnandi/iLoveU/main/FILE/PLUGINS/versi)
...
serverV=$( curl -sS https://raw.githubusercontent.com/dendikusnandi/iLoveU/main/FILE/PLUGINS/versi)
...
echo -e "$COLOR1 ${NC}                ${WH}• DENDI KUSNANDI 2023 •${NC}                 $COLOR1 $NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e ""
